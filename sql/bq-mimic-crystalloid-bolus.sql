...
(
  ...
  from `physionet-data.mimiciii_demo`.`icustays` co
  inner join `physionet-data.mimiciii_demo`.`inputevents_mv` mv
...
(
  ...
  from `physionet-data.mimiciii_demo`.`icustays` co
  inner join `physionet-data.mimiciii_demo`.`inputevents_cv` cv
